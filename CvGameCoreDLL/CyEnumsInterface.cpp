...
void CyEnumsPythonInterface()
{
	...
	python::enum_<WidgetTypes>("WidgetTypes")
		...
		.value("WIDGET_HELP_FREE_UNIT_EVERYBODY", WIDGET_HELP_FREE_UNIT_EVERYBODY)
...
// BUG - Leaderhead Relations - end
	...
	python::enum_<GameOptionTypes>("GameOptionTypes")
		...
		.value("GAMEOPTION_NO_WW", GAMEOPTION_NO_WW)
		.value("GAMEOPTION_NO_SCORE", GAMEOPTION_NO_SCORE)
		.value("GAMEOPTION_CITYCOUNT_TIED_TO_ESPIONAGE", GAMEOPTION_CITYCOUNT_TIED_TO_ESPIONAGE)
		.value("GAMEOPTION_NO_UNIT_GIFTING", GAMEOPTION_NO_UNIT_GIFTING)
		.value("GAMEOPTION_NO_WATER_BARB", GAMEOPTION_NO_WATER_BARB)
		.value("GAMEOPTION_NO_BARB_CITIES", GAMEOPTION_NO_BARB_CITIES)
		.value("GAMEOPTION_NO_SPIES", GAMEOPTION_NO_SPIES)
