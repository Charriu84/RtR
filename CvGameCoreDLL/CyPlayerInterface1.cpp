...
// BUG - end
		...
		.def("getTotalBeakersTradedAway", &CyPlayer::getTotalBeakersTradedAway, "int ()")
		...
		.def("getCivicUpkeepBonusTracking", &CyPlayer::getCivicUpkeepBonusTracking, "int (int* /*CivicTypes*/ paiCivics, bool bIgnoreAnarchy)")
